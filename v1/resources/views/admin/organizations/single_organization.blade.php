  ...
  {{csrf_field()}}
    ...
    <div class="col-lg-6">
        <div class="card m-b-30">
            ...
            <div class="card-body">
                <form action="" method="post">
                    <input class='gst' type="hidden" name="id" value="{{$organizations_data->id}}">
                <b>GSTNO</b>&ensp;
                <a href="#" class='gst' id="xeditable-gst" data-pk="{{ $organizations_data->id }}">{{$organizations_data->gst_no??''}}</a>
            </form>
                <!-- <br>
                <b>Billing Address 1</b>&ensp;
