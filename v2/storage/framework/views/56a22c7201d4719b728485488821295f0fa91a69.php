                ...
                <tbody>
                      ...
                      <?php $__currentLoopData = $Data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $response): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                          <tr>
                              ...
                              <td><b><?php echo e(Str::title($response->firstname??'')); ?></b><br><?php echo e($response->email??''); ?><br><?php echo e($response->mobile??''); ?><br><b>Gender:</b> <?php echo e(Str::title($response->gender??'')); ?></td>
                              <td>
                              ...
                              <td><?php echo e($response->answer??0); ?></td>
                               <td><?php echo e(date('d M, Y', strtotime($response->created_at??''))); ?></td>
							   <td><?php echo e(date('d M, Y', strtotime($response->last_action_date??''))); ?></td>   
...
<?php /**PATH /home/deepredink/public_html/demos/nps/v1/resources/views/admin/reports/table_lists.blade.php ENDPATH**/ ?>