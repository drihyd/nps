...
<form class="table-filter mb-4 form-inline graph_form" action="<?php echo e(route('filter.secondary.drivers')); ?>" method="post" >
<?php echo csrf_field(); ?>
...
<a href="<?php echo e(url(Config::get('constants.admin').'/graph-secondary-drivers')); ?>" class="btn btn-warning btn-sm ">Reset</a>
<?php else: ?>
<a href="<?php echo e(url(Config::get('constants.user').'/graph-secondary-drivers')); ?>" class="btn btn-warning btn-sm">Reset</a>
<?php endif; ?>
<?php else: ?>
<a href="#">
<?php endif; ?>
