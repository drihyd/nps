      ...
      <div class="row">
        ...
        <select  class="form-control" name="question_id" id="question_id" required="required">
          ...
          <?php $__currentLoopData = $questions_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $questions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($questions->id); ?>" <?php echo e(old('question_id',$questions_options_data->question_id??'') == $questions->id ? 'selected':''); ?>><?php echo e($questions->label??''); ?> - <?php echo e($questions->survey_id??''); ?></option>
...
<?php echo $__env->make('admin.template_v1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/deepredink/public_html/demos/nps/v1/resources/views/admin/question_options/add_edit_question_options.blade.php ENDPATH**/ ?>