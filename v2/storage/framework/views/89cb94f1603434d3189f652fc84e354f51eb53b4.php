            ...
            <div class="card-body">
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-xl-6">
                        <form  action="<?php echo e(url('organizations/store')); ?>" method="post" data-parsley-validate>
                        	<?php echo csrf_field(); ?>
                            <div>
                                <h3>Basic Info</h3>
                                <section>
...
<?php echo $__env->make('admin.template_v1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/deepred/public_html/demos/nps/v1/resources/views/admin/organizations/add_basicinfo.blade.php ENDPATH**/ ?>