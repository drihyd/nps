                ...
                <tbody>
                      ...
                      <?php $__currentLoopData = $users_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                          <tr>
							  ...
							  <a href="<?php echo e(url(Config::get('constants.admin').'/user/edit/'.Crypt::encryptString($user->id))); ?>" class="edit mr-2" title="Edit" ><i class="fa fa-edit"></i></a>
                                <a href="<?php echo e(url(Config::get('constants.admin').'/user/delete/'.Crypt::encryptString($user->id))); ?>" class="delete" title="Delete" onclick="return confirm('Are you sure to delete this?')" ><i class="fa fa-trash"></i></a>
