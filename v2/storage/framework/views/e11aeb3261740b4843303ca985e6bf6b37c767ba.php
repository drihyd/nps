...
<form class="form-inline" action="<?php echo e(route('filter.responses')); ?>" method="post">
<?php echo csrf_field(); ?>
...
<a href="<?php echo e(url(Config::get('constants.admin').'/responses')); ?>">Clear filter</a>
<?php else: ?>
<a href="<?php echo e(url(Config::get('constants.user').'/responses')); ?>">Clear filter</a>
<?php endif; ?>
<?php else: ?>
<a href="#">
<?php endif; ?>
...
<div class="card-body">
		...
		<?php echo $__env->make('admin.responses.table_lists',['Data'=>$Detractors], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>									
		</div>
		<div class="tab-pane fade" id="profile-line" role="tabpanel" aria-labelledby="profile-tab-line">

		<?php echo $__env->make('admin.responses.table_lists',['Data'=>$Passives], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

		</div>
		<div class="tab-pane fade" id="contact-line" role="tabpanel" aria-labelledby="contact-tab-line">

		<?php echo $__env->make('admin.responses.table_lists',['Data'=>$Promoters], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
