        ...
        var doughnutChart = new Chart(doughnutChartID, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: [
					                    "<?php echo e(Config::get('constants.Promoters')); ?>",
					                    "<?php echo e(Config::get('constants.Passives')); ?>",
					                    "<?php echo e(Config::get('constants.Detractors')); ?>",
				                    ],
                    label: 'Dataset 1'
                }],
                labels: ["<?php echo e(Config::get('constants.Promoters-label')); ?>: "+ <?php echo e($final_score->Promoters??1); ?>,
                		 "<?php echo e(Config::get('constants.Passives-label')); ?>: "+ <?php echo e($final_score->Neutral??1); ?>,
                		 "<?php echo e(Config::get('constants.Detractors-label')); ?>: "+ <?php echo e($final_score->Detractors??1); ?>,
                		 ]
            },
            options: {
                responsive: true,  
