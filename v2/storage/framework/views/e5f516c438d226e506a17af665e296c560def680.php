                ...
                <tbody>
                      ...
                      <?php $__currentLoopData = $surveys_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $survey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                          <tr>
                              ...
                              <td>
							  <a href="<?php echo e(url(Config::get('constants.admin').'/questionnaire/edit/'.Crypt::encryptString($survey->id))); ?>" class="edit mr-2" title="Edit" ><i class="fa fa-edit"></i></a>
                                <a href="<?php echo e(url(Config::get('constants.admin').'/questionnaire/delete/'.Crypt::encryptString($survey->id))); ?>" class="delete" title="Delete" onclick="return confirm('Are you sure to delete this?')" ><i class="fa fa-trash"></i></a>
