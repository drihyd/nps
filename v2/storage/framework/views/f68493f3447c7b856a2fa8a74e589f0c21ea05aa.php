...
<div class="row">
 ...
 <?php endif; ?>
        ...
        <a href="<?php echo e(url(Config::get('constants.superadmin').'/theme_options/edit/'.$theme_options_data->id)); ?>" class="edit mr-2" title="Edit" ><i class="feather icon-edit-2"></i></a>
        <a href="<?php echo e(url(Config::get('constants.superadmin').'/theme_options/delete/'.$theme_options_data->id)); ?>" class="delete text-danger" title="Delete" onclick="return confirm('Are you sure to delete this?')" ><i class="feather icon-trash"></i></a>
    </div>
        </div>
