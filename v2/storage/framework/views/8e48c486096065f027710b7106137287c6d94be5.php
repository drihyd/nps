                ...
                <tbody>
                      ...
                      <?php $__currentLoopData = $users_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                          <tr>
                              ...
                              <td><?php echo e(Str::title($user->ut_name??'')); ?></td>
                              
                           
                              
                              <td>
							  <!--
							  <a href="<?php echo e(url('organizations/user/edit/'.Crypt::encryptString($user->id))); ?>" class="edit mr-2" title="Edit" ><i class="fas fa-pen"></i></a>
                                <a href="<?php echo e(url('organizations/user/delete/'.Crypt::encryptString($user->id))); ?>" class="delete" title="Delete" onclick="return confirm('Are you sure to delete this?')" ><i class="fas fa-trash-alt"></i></a>
								-->
                              </td>
                          </tr>
