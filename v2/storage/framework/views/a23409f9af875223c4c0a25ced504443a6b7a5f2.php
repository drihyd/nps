...
<select name="ticket_status" id="ticket_status" class="form-control form-control-sm mx-sm-1" <?php if($is_required=="yes"): ?> required="required" <?php else: ?> <?php endif; ?>>
...
</div><?php /**PATH C:\xampp\htdocs\nps\v1\resources\views/admin/common_pages/action_status.blade.php ENDPATH**/ ?>