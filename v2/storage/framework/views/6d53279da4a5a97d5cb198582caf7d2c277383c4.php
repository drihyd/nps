...
<form method="POST" class="Addnewblog" action="<?php echo e(url('theme_options/update')); ?>" enctype="multipart/form-data">
<input type="hidden" name="id" value="<?php echo e($theme_options_data->id); ?>">
<?php else: ?>
<form method="POST" class="Addnewblog" action="<?php echo e(url('theme_options/store')); ?>" enctype="multipart/form-data">
<?php endif; ?>
      <?php echo csrf_field(); ?>
      <div class="row">
        <div class="col-sm-5">
