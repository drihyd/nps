...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui">
      ...
      <title><?php echo e(env('APP_NAME')); ?> - <?php echo e($company_name); ?> <?php echo $__env->yieldContent('title'); ?></title>
      <!-- Fevicon -->
	  
    <link rel="shortcut icon" href="<?php echo e($favicon_url??''); ?>">
    ...
    <!-- apex css -->
    <link href="<?php echo e(URL::to('assets/plugins/apexcharts/apexcharts.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(URL::to('assets/plugins/c3/c3.min.css')); ?>" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="<?php echo e(URL::to('assets/plugins/chartist-js/chartist.min.css')); ?>">
    <!-- End css -->
...
<?php echo $__env->make('admin.common_pages.manager_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php elseif(Auth::user()->role==3): ?>
<?php echo $__env->make('admin.common_pages.hod_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php elseif(Auth::user()->role==4): ?>
<?php echo $__env->make('admin.common_pages.user_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php elseif(Auth::user()->role==5): ?>
<?php echo $__env->make('admin.common_pages.operantionalhead_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php elseif(Auth::user()->role==6): ?>
<?php echo $__env->make('admin.common_pages.coo_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php elseif(Auth::user()->role==7): ?>
<?php echo $__env->make('admin.common_pages.support_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php else: ?>
<?php endif; ?>
...
<?php echo $__env->make('admin.common_pages.top-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('admin.common_pages.breadcrump_manager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php elseif(Auth::user()->role==3): ?>

<?php echo $__env->make('admin.common_pages.top-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('admin.common_pages.breadcrump_hod', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php elseif(Auth::user()->role==4): ?>

<?php echo $__env->make('admin.common_pages.top-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('admin.common_pages.breadcrump_user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>


<?php elseif(Auth::user()->role==5): ?>

<?php echo $__env->make('admin.common_pages.top-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('admin.common_pages.breadcrump_opthead', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php elseif(Auth::user()->role==6): ?>

<?php echo $__env->make('admin.common_pages.top-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('admin.common_pages.breadcrump_coo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php elseif(Auth::user()->role==7): ?>

<?php echo $__env->make('admin.common_pages.top-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('admin.common_pages.breadcrump_support', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php endif; ?>
    ...
    <!-- Chart js -->
    <script src="<?php echo e(URL::to('assets/plugins/chart.js/chart.min.js')); ?>"></script>
    <script src="<?php echo e(URL::to('assets/plugins/chart.js/chart-bundle.min.js')); ?>"></script>
    <!-- <script src="<?php echo e(URL::to('assets/js/custom/custom-chart-chartjs.js')); ?>"></script>  -->
...
<script src="<?php echo e(URL::to('assets/js/custom/custom-dashboard-crypto.js')); ?>"></script>

<script src="<?php echo e(URL::to('assets/plugins/d3/d3.min.js')); ?>"></script>
    <script src="<?php echo e(URL::to('assets/plugins/c3/c3.min.js')); ?>"></script>
    <script src="<?php echo e(URL::to('assets/plugins/chart.js/chart.min.js')); ?>"></script>
    <script src="<?php echo e(URL::to('assets/plugins/chart.js/chart-bundle.min.js')); ?>"></script>
    <script src="<?php echo e(URL::to('assets/plugins/chartist-js/chartist.min.js')); ?>"></script>
    <script src="<?php echo e(URL::to('assets/plugins/chartist-js/chartist-plugin-tooltip.min.js')); ?>"></script>

<?php echo $__env->make('admin.common_pages.functions_js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  <!-- End js -->
...
</html><?php /**PATH C:\xampp\htdocs\nps\v1\resources\views/admin/template_v1.blade.php ENDPATH**/ ?>