...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="card m-b-30">
            ...
            <div class="card-body">
			<form class="table-filter form-inline mb-4" action="<?php echo e(route('filter.levels')); ?>" method="post">
<?php echo csrf_field(); ?>
