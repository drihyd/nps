                    ...
                    <div class="col-lg-6 col-xl-6">
                        <form  action="<?php echo e(url('organizations/update_license')); ?>" method="post">
                            ...
                            <div>
                                ...
                                <input type="date" name="license_startdate" class="form-control"/ required="required" value="<?php echo e(old('license_startdate',$organizations_data->license_startdate??Carbon\Carbon::now()->format('Y-m-d'))); ?>">
                                    ...
                                    <span class="input-group-text" id="basic-addon2"><i class="feather icon-calendar"></i></span> -->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="license_period_year" id="formControlSelect3" required="required">
                                                            ...
                                                            <option value="1" <?php if($organizations_data->license_period_year??'1' == '1'): ?> selected <?php else: ?> <?php endif; ?>>1</option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="license_period_month" id="formControlSelect4" required="required">
                                                            ...
                                                            <option value="0" <?php if($organizations_data->license_period_month??'0' == '0'): ?> selected <?php else: ?> <?php endif; ?>>00</option>
