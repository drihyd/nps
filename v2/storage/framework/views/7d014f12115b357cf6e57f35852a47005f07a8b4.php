      ...
      <div class="row">
        <div class="col-md-5">
		  ...
		  <div class="form-group">
            ...
            <input type="number" class="form-control" name="esc_minitues" required="required" value="<?php echo e(old('esc_minitues',$group_level_data->esc_minitues??'')); ?>" />
          </div>
      <button type="submit" class="btn btn-primary btn-sm">Save</button>
      <a href="<?php echo e(url(Config::get('constants.admin').'/designations')); ?>" class="btn btn-default btn-sm">Back</a>
...
<?php echo $__env->make('admin.template_v1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/deepredink/public_html/demos/nps/v1/resources/views/admin/designationsgroup/add_edit_grouplevels.blade.php ENDPATH**/ ?>