...
<ul class="vertical-submenu">
<li class="<?php echo e((request()->is(Config::get('constants.admin').'/responses_reports')) ? 'active' : ''); ?>"><a href="<?php echo e(url(Config::get('constants.admin').'/responses_reports')); ?>">Detractors Reports</a></li>
</ul>
</li>
...
<!-- End Sidebar -->
</div><?php /**PATH /home/deepredink/public_html/demos/nps/v1/resources/views/admin/common_pages/manager_sidebar.blade.php ENDPATH**/ ?>