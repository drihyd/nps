...
<div class="card m-b-30" style="min-height:372px">
                            ...
                            <div class="card-body text-center">
							   ...
							   <div class="bg-light-gradient" style="border-radius: 8px; padding-top:18px; padding-bottom:0px; padding-left:12px; padding-right:12px">
									...
									<div class="col-md-4">
										...
										<tr>
										<td><p style="color:#119460">0</p></td>
										<td><p style="color:#FF981F">0</p></td>
										<td><p style="color:#ff654d">0</p></td>
										</tr>
										</table>
										</div>
									</div>
    ...
    </div><?php /**PATH C:\xampp\htdocs\nps\v1\resources\views/admin/common_pages/split_nps_score_widget.blade.php ENDPATH**/ ?>