...
<li class="{{ (request()->is(Config::get('constants.hod').'/responses_reports/?ticket_status=process-pending')) ? 'active' : '' }}"><a href="{{url(Config::get('constants.hod').'/responses_reports/?ticket_status=process-pending')}}">Process Pending</a></li>
<li class="{{ (request()->is(Config::get('constants.hod').'/responses_reports/?ticket_status=patient_level_closure')) ? 'active' : '' }}"><a href="{{url(Config::get('constants.hod').'/responses_reports/?ticket_status=patient_level_closure')}}">Patient level Closed</a></li>
